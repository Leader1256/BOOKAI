...
const Home = () => {
  return (
     ...
     <h1>
        ...
        <a href="/playground" class="cta">Get Started</a>
        <a href="/api" class="cta">Get API Access</a>
        <br></br>
        <br></br>

        <p style={{color: "yellow" ,textAlign:"center"}}><span>Attention:</span>TryBookAI has been acquired by Indicus AI. Indicus LLM will be used for text and image generation</p>
       </section>

       <section class="main-content">
        <div class="ai-demo">
          <img src="https://raw.githubusercontent.com/adarshagupta/trybookai/main/book2.png" alt="AI Book Generator" />
          <div class="floating-ui top-left">
            <div class="floating-icon"></div>
            <img src="https://raw.githubusercontent.com/adarshagupta/trybookai/main/public-assets/paradox.png" alt="" sizes="" srcset="" width="90px" height="130px" />
          </div>
          <div class="floating-ui bottom-right">
            <div class="floating-icon"></div>
      ...
      <section class="main-content">
        <div class="ai-demo">
          <div  class="dummy"><iframe src="https://demo.arcade.software/OvUdnIEhwNxssQsB3COY?embed&amp;show_copy_link=true" title="BookAI: Revolutionary AI-Powered Book Generation | Create Professional Books in Minutes" frameborder="0" loading="lazy" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen="" allow="clipboard-write" class="iframedummy" ></iframe></div>
          <div class="floating-ui bottom-right">
            <div class="floating-icon"></div>
            <span>Chapter complete</span>
          </div>
